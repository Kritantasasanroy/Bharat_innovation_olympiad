...
const NAV: (NavLeaf | NavGroup)[] = [
    { label: 'Dashboard', href: '/dashboard' },
    {
        ...
        items: [
            ...
            { label: 'Slot management', href: '/slot-management' },
        ],
    },
    {
        label: 'Results',
    ...
    },
    {
        ...
        items: [
            ...
            // Schools students added because they were not yet in the directory.
            { label: 'Student-onboarded schools', href: '/student-schools' },
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Review queue', href: '/proctor/review' },
