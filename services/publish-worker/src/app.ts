...
/**
 * Assembled worker application shell for `publish-worker`.
 *
...
export const app = new Elysia()
	.get("/health/live", () => ({ status: "ok", service: "publish-worker", check: "live" }))
	.get("/health/ready", () => ({ status: "ok", service: "publish-worker", check: "ready" }));
