...
/**
 * Assembled worker application shell for `analytics-worker`.
 *
...
export const app = new Elysia()
	.get("/health/live", () => ({ status: "ok", service: "analytics-worker", check: "live" }))
	.get("/health/ready", () => ({ status: "ok", service: "analytics-worker", check: "ready" }));
