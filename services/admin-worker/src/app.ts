...
/**
 * Assembled worker application shell for `admin-worker`.
 *
...
export const app = new Elysia()
	.get("/health/live", () => ({ status: "ok", service: "admin-worker", check: "live" }))
	.get("/health/ready", () => ({ status: "ok", service: "admin-worker", check: "ready" }));
