...
const SECTIONS: { heading: string; paragraphs: string[]; list?: string[] }[] = [
    ...
    },
    {
        ...
        paragraphs: [
            'We collect the participant\'s name, email, mobile number, class, section, school, a face template, a photo captured once at registration, parent or guardian contact details, optional demographic details, and the records generated by taking an exam.',
            ...
            'The face scan is stored as an encrypted mathematical descriptor and is used only to check that the person sitting an exam is the person who registered. Separately, one photo is captured at the same moment and is kept and printed on the participant\'s certificate; no other image of the participant is ever stored, other than a photo taken at the moment an exam violation is recorded (see clause 5).',
