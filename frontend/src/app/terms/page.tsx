...
const SECTIONS: { heading: string; paragraphs: string[]; list?: string[] }[] = [
    {
        ...
        paragraphs: [
            'The Bharat Innovation Olympiad ("the Olympiad") is open to wards studying in Grades 6 to 12 at a recognised school in India. One account per ward. A ward may hold only one registration per season.',
            'Registration must be completed by the ward, with a parent or legal guardian present. The face scan captured during registration identifies the ward in every exam they sit; enrolling any other person\'s face is grounds for disqualification.',
        ],
    },
    {
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'The fee is NON-REFUNDABLE and NON-TRANSFERABLE. It cannot be moved to another ward, another account, or a later season. This applies whether or not the ward goes on to sit an exam.',
    ...
    },
    {
        ...
        paragraphs: [
            'Each exam is sat on a schedule chosen by the ward, subject to availability. Places on each schedule are limited.',
            'A schedule selection is FINAL once confirmed and cannot be changed by the ward. Only the organisers may move a confirmed booking, at their discretion, and only where there is good reason. A ward who does not appear for their schedule has no automatic right to another sitting.',
        ],
    },
    {
        ...
        list: [
            ...
            'The timer runs on our servers. It continues if the ward\'s connection drops.',
            'The ward must sit the exam alone, without notes, books, additional devices, or help from anyone.',
        ],
    },
    {
        ...
        paragraphs: [
            ...
            'A ward who believes a decision is wrong may raise a grievance from their results page. Grievances are reviewed by the organisers, whose decision is final.',
        ],
    },
    {
        heading: '7. Results and certificates',
        paragraphs: [
            'Immediately after an exam the ward may see a PROVISIONAL, unverified score. A provisional score is not a result: it may change as a consequence of proctoring review, grievances, or the fair-score normalisation applied across all participants.',
    ...
    },
    {
        ...
        paragraphs: [
            'We collect the ward\'s name, email, mobile number (optional), class, section, school, a face template, parent or guardian contact details, optional demographic details, and the records generated by taking an exam.',
            'We use them to run the Olympiad: to identify the ward, to deliver and proctor exams, to mark and rank, to issue certificates, and to contact the ward and their guardian about the Olympiad.',
            ...
            'Results may be shared with the ward\'s school and, where a school or partner enrolled the ward, with that partner. We do not sell personal data.',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'The practice paper exists so these can be checked in advance, and we strongly recommend using it on the same device the ward intends to use for the real exam.',
        ],
    },
    {
        heading: '10. Changes to these terms',
        paragraphs: [
            'We may revise these terms. Each version is recorded, and the version a ward accepted is stored against their registration. Where a revision materially affects participants, we will ask for fresh acceptance rather than relying on the earlier one.',
        ],
    },
    {
        heading: '11. Contact',
