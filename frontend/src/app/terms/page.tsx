...
const SECTIONS: { heading: string; paragraphs: string[]; list?: string[] }[] = [
    {
        ...
        paragraphs: [
            'The Bharat Innovation Olympiad ("the Olympiad") is open to students studying in Grades 6 to 12 at a recognised school in India. One account per student. A student may hold only one registration per season.',
            'Registration must be completed by the student, with a parent or legal guardian present. The face scan captured during registration identifies the student in every exam they sit; enrolling any other person\'s face is grounds for disqualification.',
        ],
    },
    {
        heading: '2. Parental consent and children\'s data',
        paragraphs: [
            'Every participant is a minor or may be a minor. In line with the Digital Personal Data Protection Act, 2023, we collect verifiable consent from a parent or legal guardian before a student sits any exam. That consent covers both the student\'s participation and the processing of their personal data for the purposes described below.',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'The fee is NON-REFUNDABLE and NON-TRANSFERABLE. It cannot be moved to another student, another account, or a later season. This applies whether or not the student goes on to sit an exam.',
            'The free practice paper is available without payment.',
        ],
    },
    {
        heading: '4. Exam slots',
        paragraphs: [
            'Each exam is sat in a scheduled slot chosen by the student, subject to availability. Places in each slot are limited.',
            'A slot selection is FINAL once confirmed and cannot be changed by the student. Only the organisers may move a confirmed booking, at their discretion, and only where there is good reason. A student who does not appear in their slot has no automatic right to another sitting.',
        ],
    },
    {
        heading: '5. Exam conditions and proctoring',
        paragraphs: [
            'Exams are taken online under AI-assisted proctoring. By sitting an exam the student and their guardian accept the following conditions.',
        ],
        list: [
            ...
            'The student must sit the exam alone, without notes, books, additional devices, or help from anyone.',
        ],
    },
    {
        ...
        paragraphs: [
            ...
            'A student who believes a decision is wrong may raise a grievance from their results page. Grievances are reviewed by the organisers, whose decision is final.',
        ],
    },
    {
        heading: '7. Results and certificates',
        paragraphs: [
            'Immediately after an exam the student may see a PROVISIONAL, unverified score. A provisional score is not a result: it may change as a consequence of proctoring review, grievances, or the fair-score normalisation applied across all participants.',
    ...
    },
    {
        ...
        paragraphs: [
            'We collect the student\'s name, email, mobile number (optional), class, section, school, a face template, parent or guardian contact details, optional demographic details, and the records generated by taking an exam.',
            'We use them to run the Olympiad: to identify the student, to deliver and proctor exams, to mark and rank, to issue certificates, and to contact the student and their guardian about the Olympiad.',
            ...
            'Results may be shared with the student\'s school and, where a school or partner enrolled the student, with that partner. We do not sell personal data.',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            'The practice paper exists so these can be checked in advance, and we strongly recommend using it on the same device the student intends to use for the real exam.',
        ],
    },
    {
        heading: '10. Changes to these terms',
        paragraphs: [
            'We may revise these terms. Each version is recorded, and the version a student accepted is stored against their registration. Where a revision materially affects participants, we will ask for fresh acceptance rather than relying on the earlier one.',
        ],
    },
    {
        heading: '11. Contact',
            ...
            <div className="legal-container">
                ...
                <header className="legal-header">
                    ...
                    <p className="legal-intro">
                        ...
                        on the registration form, means the student and their parent or guardian
                        accept them.
                    </p>
                </header>
